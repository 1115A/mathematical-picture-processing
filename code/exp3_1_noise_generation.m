...
exportgraphics(fig1, fullfile(rootDir, 'results', 'exp3_1_gaussian_noise.png'), 'Resolution', 180);
close(fig1);
...
exportgraphics(fig2, fullfile(rootDir, 'results', 'exp3_1_salt_pepper_noise.png'), 'Resolution', 180);
close(fig2);
end
